...
def train_ablation(iter_break,erase_cat,erased_index, lr, config_path, ckpt_path, diffusers_config_path, devices,ddim_steps=50):
    '''
    ...
    name = f'abconcept-{erase_cat}-erased_index_{erased_index}-iter_{iter_break}'
...
if __name__ == '__main__':
    ...
    train_ablation(args.iter_break, args.erase_cat, args.erased_index,args.lr, args.config_path, args.ckpt_path, args.diffusers_config_path, devices, args.ddim_steps)
