...
import argparse
import os
def generate_images(prompts_path, save_path, device='cuda:0', guidance_scale = 7.5, image_size=512, ddim_steps=100, num_samples=10, from_case=0):
    '''
    ...
    model_name = 'ori'# 'compvis-word_VanGogh-method_xattn-sg_3-ng_1-iter_1000-lr_1e-05-beta_1e-05-sw_0-stw_5-sign-2'
    model_name0 = 'FMN-object-erased_index_0-iter_50'
    model_name1 = 'FMN-object-erased_index_1-iter_50'
    model_name2 = 'FMN-object-erased_index_2-iter_50'
    model_name3 = 'FMN-object-erased_index_3-iter_30'
    model_name4 = 'FMN-object-erased_index_4-iter_50'
    model_name5 = 'FMN-object-erased_index_5-iter_50'

    model_path = f'models/{model_name}/{model_name.replace("compvis","diffusers")}.pt'
    model_path0 = f'models/{model_name0}/{model_name0.replace("compvis","diffusers")}.pt'
    model_path1 = f'models/{model_name1}/{model_name1.replace("compvis","diffusers")}.pt'
    model_path2 = f'models/{model_name2}/{model_name2.replace("compvis","diffusers")}.pt'
    model_path3 = f'models/{model_name3}/{model_name3.replace("compvis","diffusers")}.pt'
    model_path4 = f'models/{model_name4}/{model_name4.replace("compvis","diffusers")}.pt'
    model_path5 = f'models/{model_name5}/{model_name5.replace("compvis","diffusers")}.pt'
    model_state_dict = torch.load(model_path)
    model_state_dict0 = torch.load(model_path0)
    model_state_dict1 = torch.load(model_path1)
    model_state_dict2 = torch.load(model_path2)
    model_state_dict3 = torch.load(model_path3)
    model_state_dict4 = torch.load(model_path4)
    model_state_dict5 = torch.load(model_path5)
    for key in model_state_dict.keys():
        if 'attn2.to_k' in key or 'attn2.to_v' in key:
            v0 = model_state_dict0[key] - model_state_dict[key]
            v1 = model_state_dict1[key] - model_state_dict[key]
            v2 = model_state_dict2[key] - model_state_dict[key]
            v3 = model_state_dict3[key] - model_state_dict[key]
            v4 = model_state_dict4[key] - model_state_dict[key]
            v5 = model_state_dict5[key] - model_state_dict[key]
            model_state_dict[key] = model_state_dict[key] +  v5#  12 1234 234 
    ...
    folder_path = f'{save_path}/5'# 12345
...
if __name__=='__main__':
    ...
    parser.add_argument('--device', help='cuda device to run on', type=str, required=False, default='cuda:4')
