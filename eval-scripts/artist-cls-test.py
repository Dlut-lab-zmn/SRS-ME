...
print(f'test-acc0_{eval_acc_0 / eval_n_0}-acc1_{eval_acc_1 / eval_n_1}-acc2_{eval_acc_2 / eval_n_2}-acc3_{eval_acc_3 / eval_n_3}-acc4_{eval_acc_4 / eval_n_4}-acc5_{eval_acc_5 / eval_n_5}-acc6_{eval_acc_6 / eval_n_6}-acc7_{eval_acc_7 / eval_n_7}-acc8_{eval_acc_8 / eval_n_8}')
