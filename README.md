...
* python eval-scripts/lpips_eval.py --path1 './evaluation_folder/ori-merge' --path2 './evaluation_folder-diff/012-merg'
* python eval-scripts/FID_eval.py --path1 './evaluation_folder/default-merge' --path2 './evaluation_folder-diff/012-merge'
## Citing our work
