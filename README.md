...
python eval-scripts/generate-images.py --model_name='default' --prompts_path './data/evaluate_classify.csv' --save_path 'evaluation_folder-diff' --num_samples 2 --device 'cuda:5'

rename the file name as eval
python train-scripts/move_image.py
python train-scripts/artist-cls-test.py --path './evaluation_folder-diff/'
file_name: eval
    -- 0 ''
    -- 1 'vangogh'
    -- 2 'picasso'
